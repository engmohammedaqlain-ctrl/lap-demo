/**
 * BuoyancyApp.jsx — تجربة الطفو (أرخميدس). كانت سابقاً App.jsx؛ نُقلت هنا
 * لتصبح إحدى تجربتين يختار بينهما المستخدم من الشاشة الرئيسية. أُضيف زر
...
export default function BuoyancyApp({ onHome }) {
