 ...
 */
export const STAGES = {
  droplet: { in: [0.0, 0.02], out: [0.06, 0.09], mag: "×1" },
  prep: { in: [0.05, 0.08], out: [0.2, 0.28], mag: "×10" },
  cluster: { in: [0.24, 0.32], out: [0.44, 0.54], mag: "×40" },
...
/* ===== المقدّمة حسب نوع الخلية ===== */
// الحيوانية: وجه إنسان ← الخدّ ← خلايا الجلد. النباتية: بصلة ← قشرة ← خلايا البصل.
export const INTRO = {
  animal: {
    subject: "face",
    label: "خدّ إنسان",
    sublabel: "نغوص في خلايا بطانة الخدّ",
    tint: "#f4c9a8",
    /* خطوات تحضير الشريحة: عيّنة من بطانة الفم (مسحة قطنية) */
    prepSteps: [
      "نأخذ عيّنة من خلايا بطانة الفم بمسحة قطنية",
      "نمسحها برفق على شريحة زجاجية",
      "نُسقط قطرة صبغة (ميثيلين أزرق) لتظهر الخلايا",
      "نُغطّيها بغطاء زجاجي رقيق ونضعها تحت المجهر",
    ],
  },
  plant: {
    subject: "onion",
    label: "بصلة",
    sublabel: "نغوص في خلايا قشرة البصل",
    tint: "#e8d7b0",
    /* خطوات تحضير الشريحة: رقاقة رقيقة من قشرة البصل */
    prepSteps: [
      "نُقشّر رقاقة رقيقة شفّافة من قشرة البصلة",
      "نضعها مسطّحة على شريحة زجاجية",
      "نُسقط قطرة كاشف اليود لتلوّن الخلايا",
      "نُغطّيها بغطاء زجاجي رقيق ونضعها تحت المجهر",
    ],
  },
};
