  ...
  return (
    <div className="cl-help-overlay" onClick={onClose}>
      <div className="cl-help-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <span className="cl-help-sub">من الشريحة تحت المجهر… إلى داخل الخلية الحيّة</span>

        <p className="cl-help-intro">
          الخلية هي وحدة بناء كل الكائنات الحيّة. نبدأ من شريحة جاهزة على منضدة المجهر،
          ثم تُكبّر أنت بنفسك: نسيج خلايا ← خلية واحدة ← داخلها، فنتجاوز حدّ المجهر
          المدرسي ونرى عضيّاتها تعمل وتتنفّس كما في الحقيقة.
        </p>

        <div className="cl-help-section">
          <h3>كيف أتنقّل؟</h3>
          <ul className="cl-help-list">
            <li>كبّر/صغّر بعجلة الماوس، أو بإصبعين (pinch) على الجوال — ابدأ بالتكبير على الشريحة الموضوعة على المجهر.</li>
            ...
            <li>زر ⏸️ يثبّت حركة الأجسام (عرض ساكن)، و▶️ يعيد الحركة.</li>
          </ul>
        </div>
