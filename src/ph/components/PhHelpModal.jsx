      ...
      <div className="help-modal" role="dialog" aria-modal="true" aria-labelledby="ph-help-title">
        ...
        <section className="help-section">
          ...
          <ul className="help-list">
            ...
            <li>
              في وضع <strong>«حضّر محاليلك»</strong>: عبّئ أنبوبَي الاختبار بأي سائل، راقب pH كل
              أنبوب، ثم أمسك الأنبوب واسحبه فوق الكأس؛ يميل ويفرغ محتواه كاملاً دفعة واحدة،
              ويُحسب pH المزيج علمياً من تركيز الأيونات.
            </li>
          </ul>
        </section>
